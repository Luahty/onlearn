    ...
    return (
        <div className="bg-white">
            <div className="mx-auto">
                <div className="relative isolate overflow-hidden h-[700px] bg-[#D2E6E4] px-6 pt-16 rounded-b-3xl sm:px-16 md:pt-24 lg:flex lg:px-24 lg:pt-0">
                    ...
                    <div className="mx-auto max-w-2xl text-center mt-10 lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <h1 className="text-6xl lx:text-7xl font-semibold tracking-tight text-[#0B7077]">
